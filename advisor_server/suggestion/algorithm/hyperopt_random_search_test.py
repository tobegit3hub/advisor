...
class HyperoptRandomSearchAlgorithmTest(TestCase):
  def setUp(self):
  ...
  def test_init(self):
    instance = HyperoptRandomSearchAlgorithm()

    self.assertTrue(isinstance(instance, AbstractSuggestionAlgorithm))

    self.assertEqual(instance.__class__, HyperoptRandomSearchAlgorithm)

  def test_get_new_suggestions(self):
    hyperoptRandomSearchAlgorithm = HyperoptRandomSearchAlgorithm()

    new_trials = hyperoptRandomSearchAlgorithm.get_new_suggestions(
