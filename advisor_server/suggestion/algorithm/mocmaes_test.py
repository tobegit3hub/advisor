...
class MocmaesAlgorithmTest(TestCase):
  def setUp(self):
    ...
    self.study = Study.create("CmaesStudy", study_configuration)

  def tearDown(self):
    pass

  def test_init(self):
    instance = MocmaesAlgorithm()

    self.assertTrue(isinstance(instance, AbstractSuggestionAlgorithm))

    self.assertEqual(instance.__class__, MocmaesAlgorithm)
